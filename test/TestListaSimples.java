...
class TestListaSimples {
    ...
    ListaSimples<Integer> gera_lista() {
        ListaSimples<Integer> q = new ListaSimples<>( );
    ...
    void insere() throws InterruptedException, IOException {
        ...
        q.insere(0, 321);
        assert(q.obtem(0).equals(321));
        assert(q.obtem(1).equals(123));
        assert(q.comprimento() == 2);

        q.insere(1, 555);
        assert(q.obtem(0).equals(321));
        assert(q.obtem(1).equals(555));
        assert(q.obtem(2).equals(123));
        assert(q.comprimento() == 3);
        ...
        assert(q.obtem(1).equals(555));
        assert(q.obtem(2).equals(123));
        assert(q.obtem(3).equals(777));
        assert(q.comprimento() == 4);
...
//        }
    ...
    void insere_aleatorio() throws InterruptedException, IOException {
        ListaSimples<Integer> q = gera_lista();
